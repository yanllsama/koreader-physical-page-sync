...
local function applyPerfectSync(physical_pages)
        ...
        -- PocketBook'ta manuel UI değişkenlerine müdahale etmek sayfa çevirmede çökmeye neden oluyor.
        -- O yüzden show_page_labels gibi cihazı hazırlıksız yakalayan atamaları sildik.
        if pagemap then
            pagemap.chars_per_synthetic_page = cpp
            pagemap.page_labels_cache = nil
            -- KOReader, menüdeki UsePageLabelsUpdated tetikleyicisiyle arayüzü kendisi güvenle çizecek.
        end
